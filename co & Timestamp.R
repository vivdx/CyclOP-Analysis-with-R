...
dbExistsTable(con,"analysis_co")

dbSendQuery(con, paste("insert into analysis_co (standard_deviation,time,variance,mean,id) VALUES ( '",sd,"','",time,"','",v,"','",mean,"','",mid,"');",sep=""))
